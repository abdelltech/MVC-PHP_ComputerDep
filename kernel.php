<?php
	...
	if(is_readable($controllerFile)){
		...
		if(is_callable(array($controller, $methodName)))  $method=$methodName;
		else  $method="index";

		if(!empty($argsArray))  call_user_func_array(array($controller, $method), $argsArray);
		else  call_user_func(array($controller, $method));
